...
function camera(d,ds){if(!ds)ds=100;
...
function xyz(ad,dc,ds){
    var x=0-Math.round(Math.sin(ad)*ds,2);
    var y=Math.round(Math.sin(dc)*ds,2);
    var z=Math.round(Math.cos(ad-dc)*ds,2);
    return {x:x,y:y,z:z};}
